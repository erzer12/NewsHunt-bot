 ...
 * Footer Component
 * 
 * This component renders the site footer with multiple columns of links
 * and contact information.
 * 
 * CUSTOMIZATION OPTIONS:
 * 1. Edit company information and social links in the config.ts file
 * 2. Modify the navigation menu items to match your site structure
 * 3. Update contact information in the config.ts file
 * 
 * DEVELOPER NOTES:
 * - The footer shares navigation with the header component for consistency
 * - Social media links are pulled from config.socialLinks
 * - Contact information uses config.contactEmail, config.phone, and config.address
 */
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">{config.phone}</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
